                ...
                <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
                    ...
                    <div class="flex flex-col rounded-lg bg-white sm:flex-row"
                        ...
                        <img class="m-2 h-24 w-28 rounded-md border object-cover object-center"
                            :src="product.data.thumbnail" alt="" />
                        <div class="flex w-full flex-col px-4 py-4">
                            <span class="font-semibold">{{ product.data.title }}</span>
                ...
                <div class="">
                    ...
                    <div class="mt-6 border-t border-b py-2">
                        <div class="flex items-center justify-between">
                            ...
                            <p class="font-semibold text-gray-900">$ {{ cartStore.totalPrice }}</p>
                        </div>
                        <div class="flex items-center justify-between">
                            <p class="text-sm font-medium text-gray-900">Shipping</p>
                            <p class="font-semibold text-gray-900">$ {{ cartStore.shipping }}</p>
                        </div>
                        <div class="flex items-center justify-between">
                            <p class="text-sm font-medium text-gray-900">Tax</p>
                            <p class="font-semibold text-gray-900">$ {{ cartStore.getTax }}</p>
                        </div>
                    </div>
                    <div class="mt-6 flex items-center justify-between">
                        <p class="text-sm font-medium text-gray-900">Total</p>
                        <p class="text-2xl font-semibold text-gray-900">$ {{ cartStore.totalCost }} </p>
                    </div>
                </div>
                <button class="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white"
                    @click="checkout_complete()">Place
                    Order</button>
            </div>
        </div>
